...
const labelClass = "block text-[11px] uppercase tracking-[0.12em] text-[#C3CCDD] font-bold leading-snug";
...
const pairedRowClass = "grid grid-cols-1 gap-5 sm:grid-cols-2 sm:gap-x-5 sm:grid-rows-[auto_auto_auto]";
...
function Field({ id, label, required, helper, error, paired, children }: FieldProps) {
  return (
