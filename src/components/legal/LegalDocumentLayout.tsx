...
export function LegalDocumentLayout(props: Props) {
  ...
  return <div className="legal-page w-full bg-[#040B16]">
    ...
    <main className="legal-main">
      <div className="legal-container"><LegalDocumentMeta/><section className="legal-summary" aria-labelledby="document-summary"><p className="legal-eyebrow">Document overview</p><h2 id="document-summary">{props.summaryTitle ?? "A clear framework for responsible use."}</h2><div>{props.summary}</div></section>
